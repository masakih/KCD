...
class HMGetShipCommand: HMCompositCommand, NSCopying {
	...
	override class func canExcuteAPI(api: String) -> Bool {
		return api == "/kcsapi/api_req_kousyou/getship"
	}
	...
	class func commands() -> [AnyObject] {
		return [HMMemberSlotItemCommand(), HMMemberShipCommand(), HMKenzoMarkCommand(), HMMemberKDockCommand()]
	}
}
