...
class HMDestroyShipCommand: HMCompositCommand, NSCopying {
	...
	override class func canExcuteAPI(api: String) -> Bool {
		return api == "/kcsapi/api_req_kousyou/destroyship"
	}
	...
	class func commands() -> [AnyObject] {
		return [HMMemberMaterialCommand(), HMRealDestroyShipCommand()]
	}
}
