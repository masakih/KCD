...
//  KCD
//
//  Created by Hori,Masaki on 2015/01/14.
//  Copyright (c) 2015年 Hori,Masaki. All rights reserved.
//

import Cocoa

class HMRemodelSlotCommand: HMCompositCommand, NSCopying {
	...
	override class func canExcuteAPI(api: String) -> Bool {
		return api == "/kcsapi/api_req_kousyou/remodel_slot"
	}
	...
	class func commands() -> [AnyObject] {
		return [HMMemberMaterialCommand(), HMRemodelSlotItemCommand()]
	}
}
